...
export const Video: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-name={props.name} className={props.className}>
      <path d="M10.5 15.1499L14.48 12.8699C15.15 12.4799 15.15 11.5199 14.48 11.1299L10.5 8.84991C9.83 8.46991 9 8.94991 9 9.71991V14.2799C9 15.0399 9.83 15.5299 10.5 15.1499Z"/>
