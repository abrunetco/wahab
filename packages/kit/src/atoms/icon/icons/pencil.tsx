...
export const Pencil: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-name={props.name} className={props.className}>
      ...
      <path d="M17.5,3.2c-0.3-0.3-0.8-0.3-1.2,0c-0.3,0.3-0.3,0.8,0,1.2l3.3,3.3c0.3,0.3,0.8,0.3,1.2,0c0.3-0.3,0.3-0.8,0-1.2L17.5,3.2z"/>
      <path d="M15,5.7c-0.3-0.3-0.8-0.3-1.2,0l-9.4,9.4c-0.1,0.1-0.2,0.2-0.2,0.4L3,20c-0.1,0.3,0,0.6,0.2,0.8
