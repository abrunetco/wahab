import React, { MouseEvent, useCallback, useEffect, useReducer, useState } from "react"
import {
  ariaDescribedByIds,
  parseDateString,
  toDateString,
...
import { List, ListItem } from "../../../atoms/lists/Lists"
    ...
    <List flex className="list-inline">
      ...
      {(options.hideNowButton !== "undefined" ? !options.hideNowButton : true) && (
        <ListItem className="list-inline-item">
          <Button bg={"active"} padding={{ x:"l", y:"s" }} rounded="xs" typo="default" onClick={handleSetNow}>
      ...
      {(options.hideClearButton !== "undefined" ? !options.hideClearButton : true) && (
        <ListItem className="list-inline-item">
          <Button bg={"warn"} color={"white"} padding={{ x:"l", y:"s" }} rounded="xs" typo="default" onClick={handleClear}>
